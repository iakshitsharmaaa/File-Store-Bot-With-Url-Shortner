    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Updates Channel", url="https://telegram.me/sasssydivyaonlinebot")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Support Group", url="https://telegram.me/sasssydivyaonlinebot"),
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝙂𝙧𝙤𝙪𝙥](https://telegram.me/sasssydivyaonlinebot)",
                                     disable_web_page_preview=True)
            return
